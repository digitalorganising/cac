...
export const appSearchParamsParser = {
  ...
  "durations.overall.from": parseAsInteger,
  "durations.overall.to": parseAsInteger,
  "events.type": parseAsUniqueArrayOf(parseAsStringLiteral(eventTypes)),
  "company.type": parseAsUniqueArrayOf(parseAsString),
  "company.sics.section": parseAsUniqueArrayOf(parseAsString),
  "company.sics.code": parseAsUniqueArrayOf(parseAsString),
