...
def merge_withdrawals(keyed_stream_value):
    ...
    withdrawal_date = date_parse(withdrawal["application_withdrawn"])
    ...
    if (
        ...
        application_received_date = date_parse(withdrawal["application_received"])
...
keyed_outcomes = op.key_on("keyed_outcomes", outcomes_docs, lambda d: d["reference"])
...
keyed_withdrawals = op.key_on(
    "keyed_withdrawals", withdrawals_docs, lambda d: d["reference"]
)
